#!/usr/bin/env python3
"""Independent stratified exact-landscape oracles for MV5-AJ."""
...
def main():
    ...
    for unit in queue:
        ...
        for dimension, degree in (("H0", 0), ("H1", 1)):
            ...
            output.append({
                "contract_id": "mv05aj_independent_landscape_oracle_v1",
    ...
    print("MV5-AJ independently reproduced 60 stratified landscape distances.")
