...
# Run the committed MV8-V 1,257-record production queue serially. Public files
# contain aggregate/resource evidence only; diagrams and logs remain private.
...
if (!(length(args) %in% c(9L, 10L))) stop(paste(
  "usage: run_mv08v_full_ph_production.R <mv08u-prefreeze>",
