...
| P2-07 | Add CI | Parse, lint if adopted, unit tests, docs, package check, privacy check, toy smoke run | Required checks pass on supported platforms from clean checkout | `complete` — published `main` run 31768108363 passed privacy guard, exact restore, package check, and installed realistic H0/H1 fixtures |
...
- [x] CI exercises the public route and privacy guard locally and on published `main`.
