...
| 6. Biological/practical validation | HCA exact-annotation/common-475 sensitivity complete; MV8-H exact 48-file acquisition, Ensembl-93 inputs, Cell Ranger 8.0.1 runtime, and exact custom reference are independently closed with panel/runtime effects separated; only a one-unit count-sentinel prefreeze is open and all raw processing remains closed | G6 not evaluated |
