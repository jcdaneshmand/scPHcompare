...
| 6. Biological/practical validation | HCA exact-annotation/common-475 sensitivity complete; MV8-H exact 48-file acquisition, Ensembl-93 inputs, Cell Ranger 8.0.1 runtime/reference, one-unit count execution, matrix/QC review, and dual-view topology prefreeze are auditable; all five HCA exact-500 SCT seed checks are panel-blocked (497–499 retained genes), with labels/outcomes/landscapes and remaining units still closed | G6 not evaluated; owner decision required on common-475 validation or a new exact-500 strategy |
