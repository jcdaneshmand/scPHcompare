...
| 6. Biological/practical validation | HCA exact-annotation/common-475 sensitivity complete; MV8-H exact 48-file acquisition, Ensembl-93 inputs, Cell Ranger 8.0.1 runtime/reference, one-unit count execution, matrix/QC review, and the eight-unit common-475 dual-view topology/all-active-level landscape validation are auditable; all five HCA exact-500 SCT seed checks remain panel-blocked (497–499 retained genes), with labels/outcomes and fusion still closed | G6 not evaluated; owner decision required on external common-475 result interpretation/claim mapping or a new exact-500 strategy |
