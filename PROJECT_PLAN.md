...
- **Phase:** 1, 4, 5, and 7
- **Status:** MV5-P complete: all 150 label-closed production groups and 4,565 immutable distance units pass complete-matrix, exact-oracle, maximum-group byte-repeat, all-unit resume, and observed resource/storage validation; clustering, labels, and outcomes remain closed
