...
- **Phase:** 1, 4, 5, and 7
- **Status:** MV5-D0 stage 1 complete: 90 raw shards, 450 deterministic selections, and 450 validated v2 SCT caches; stop/reprojection complete; downstream MV5-D and G-MV5 remain open
...
| 4. Redesign primary comparison | MV5-D0 stage 1 complete with 90 raw shards, 450 selections, 450 v2 SCT caches, and 10.525-h SCT cell-primary reprojection; folds and outcomes not run | G4 not evaluated |
