...
- **Phase:** 1, 4, 5, and 7
- **Status:** MV5-G complete: all 75 fixed-panel label-closed integrated coordinate groups independently validate; measured reserved total passes caps; integrated cell PH is separately authorized
...
| 4. Redesign primary comparison | MV5-G complete: null SCT retrieval result retained; all 75 corrected integrated coordinate groups pass independent/deterministic/resume gates; integrated cell PH is separately authorized | G4 not evaluated |
