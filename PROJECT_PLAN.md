...
| 6. Biological/practical validation | HCA exact-annotation/common-475 sensitivity complete; MV8-H exact 48-file acquisition, Ensembl-93 inputs, Cell Ranger 8.0.1 runtime/reference, and one-unit count execution are metadata-closed with the historical prefreeze preserved; matrices/QC/labels/outcomes/landscapes and remaining units remain closed | G6 not evaluated |
