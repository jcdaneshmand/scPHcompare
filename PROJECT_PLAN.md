...
| 6. Biological/practical validation | HCA exact-annotation/common-475 sensitivity complete; MV8-H exact 48-file acquisition, Ensembl-93 inputs, Cell Ranger 8.0.1 runtime/reference, one-unit count execution, matrix/QC review, eight-unit common-475 dual-view topology/all-active-level validation, and the MV8-J provisional claim map are auditable; all five HCA exact-500 SCT seed checks remain panel-blocked (497–499 retained genes), with labels/outcomes and fusion still closed | G6 not evaluated; exact-500 recovery is conditional on a claim-specific need identified during manuscript drafting |
